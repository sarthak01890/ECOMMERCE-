...
export const products = [
    {
        _id: "aaaaa",
        name: "Formal 3 Piece Black Mens Suits",
        description: "Mens formal 1 button dinner prom slim fit 3 Piece partywear suits made from green color pure polyester fabric. It has bottom as a trouser. This suit comes with 3 Pieces (Jacket, Vest and pant) only.",
        price: 7000,
        image: [p_img1],
        category: "Men",
        subCategory: "Topwear",
